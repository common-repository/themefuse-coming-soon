...
Plugin Name:  ThemeFuse Coming Soon
Plugin URI:   http://www.themefuse.com/plugin/?plugin=coming-soon
Version:      1.1.0
Description:  Adds a coming soon page to your site that lets visitors know your site is down for maintenancetime.
Author:       Themefuse
Author URI:   http://themefuse.com/wp-themes-shop/?plugin=coming-soon

**************************************************************************/

 if ( ! defined( 'TF_MAINTENANCE_WP_PLUGIN_URL' ) )
       define( 'TF_MAINTENANCE_WP_PLUGIN_URL', WP_CONTENT_URL. '/plugins/themefuse-coming-soon' );
 if ( ! defined( 'TF_MAINTENANCE_WP_PLUGIN_URL_JS' ) )
       define( 'TF_MAINTENANCE_WP_PLUGIN_URL_JS', WP_CONTENT_URL. '/plugins/themefuse-coming-soon/js' );
...
<div id="message" class="error">
  <p>
    <?php _e( "ThemeFuse Coming Soon  plugin isn't active. Activate it here." ); ?>
  </p>
</div>
<?php }
    ...
    {
        $this->menu_page = add_options_page('ThemeFuse Coming Soon Plugin Options', 'ThemeFuse Coming Soon Plugin', 'manage_options',$this->_options_pagename, array(&$this, 'build_settings_page'));
    ...
    function build_settings_page()
    {
        ...
        if (isset($_REQUEST['saved'])) {
            if ( $_REQUEST['saved'] ) echo '<div id="message" class="updated fade"><p><strong>'.'ThemeFuse Coming Soon'.' settings saved.</strong></p></div>';
	}
...
<div class="wrap" id="tfuse_fields">
  ...
  <div class="tfuse_header">
    ...
    <div class="header_text">
      <h3>
        <?php _e( "ThemeFuse Coming Soon Plugin Options" ); ?>
      </h3>
